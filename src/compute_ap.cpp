...
main(int argc, char** argv)
{
  ...
  set<string> good_set = vector_to_set( load_list("../datasets/gt_files_170407/"  + gtq + "_good.txt") );
  // set<string> ok_set = vector_to_set( load_list("../datasets/gt_files_170407/" + gtq + "_ok.txt") );
  set<string> junk_set = vector_to_set( load_list("../datasets/gt_files_170407/" + gtq + "_junk.txt") );
